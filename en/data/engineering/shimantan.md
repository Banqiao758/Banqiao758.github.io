---
layout: default
title: Shimantan Reservoir (pre-failure engineering data)
subtitle: Data & Statistics · Engineering · Shimantan Reservoir
permalink: /en/data/engineering/shimantan/
lang: en
alt_url: /data/engineering/shimantan/
description: Engineering and hydrological specifications for Shimantan Reservoir prior to its August 1975 failure, drawn from a 1970s Henan provincial water resources bureau data compilation.
---
...
with this site's <a href="{{ '/en/data/engineering/tiangang/' | relative_url }}">Tiangang Reservoir</a> data.
...
|---|---|
| River | Hong River (洪河) |
| Construction site | Wugang County (舞阳县) |
| Controlled catchment area | 215 km&sup2; |
| Full-compensation elevation | 105.82 m |
| Channel safe discharge | 400 m&sup3;/s |
| Construction dates | 1951&ndash;1952 |
| Farmland flooded | 8,600 mu |
| Population relocated | 2,923 |

## Hydrological characteristics

| Parameter | Value |
|---|---|
| Annual runoff | 96.9M m&sup3; |
| Design flood | 2,800 m&sup3;/s |
| Check flood | 5,065 m&sup3;/s |
| Historical maximum flood | 2,560 m&sup3;/s (1908) |

## Key design levels and capacities

| Level | Elevation (m) | Corresponding capacity (M m&sup3;) |
|---|---|---|
| Dead level | 95.00 | 5.6 |
| Normal (beneficial) level | 105.0 | 46.3 |
| Pre-flood-season limit level | 100.10 | 22.8 |
| Design flood level (1-in-50-year) | 107.00 | 68.3 |
| Check flood level (1-in-500-year) | 109.30 | 91.8 |
...
| Max dam height | 25.0 m |
| Dam crest elevation | 109.85 m |
| Wave-wall crest elevation | 111.05 m |
| Dam crest width | 6.0 m |
| Dam crest length | 500 m |
| Outlet works max discharge | 109.0 m&sup3;/s |
| Main spillway | Flat rolling steel gates, 2 bays, each 5&times;10 m |
| Main spillway max discharge | 400 m&sup3;/s |

## Construction investment

| Parameter | Value |
|---|---|
| Earth/rock excavation | 209,600 m&sup3; |
...
|---|---|---|---|
| 1954 | 147 | 1,620 | 101.59 |
| 1956 | 187.4 | 1,500 | 102.66 |
| 1963 | 173.2 | 1,461 | 106.89 |
